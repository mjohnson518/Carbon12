...
contract Carbon12Portfolio is IERC998ERC721TopDown, ERC165,ERC998ERC721TopDownEnumerable, ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable{
 ...
 function slice(
    ...
    function toAddress(bytes32 _bytes, uint256 _start) internal pure returns (address) {
...
// child contract address mapped to child tokenId or amount
    ...
    function addChild(uint256 _tokenId, address _childContract, uint256 _childTokenId)public returns(bytes32){
